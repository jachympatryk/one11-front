...
//   } = useQuery(
//     ['userFunctionaries', userId],
//     () => fetchUserFunctionary(userId as number),
//     {
//       enabled: !!userId,
//       staleTime: 1000 * 60 * 10, // Dane odświeżane co 10 minut
//     }
//   );
//
//   const { data: functionaries, isFetching: isFetchingFunctionaries } =
//     useGetUserFunctionariesQuery(1);
//   const { data: players, isFetching: isFetchingPlayers } =
//     useGetUserPlayersQuery(1);
//
//   console.log(functionaries, players);
//
//   const {
//     data: userPlayers = [],
...
//
//   useEffect(() => {
//     const savedFunctionality = localStorage.getItem(
//       'userSelectedFunctionality'
//     );
//     if (savedFunctionality) {
//       setUserSelectedFunctionality(JSON.parse(savedFunctionality));
...
//           'userSelectedFunctionality',
//           JSON.stringify(selectedFunctionality)
//         );
